...
namespace TFU_Building_API.Controllers
{
    ...
    public class OwnerShipController : ControllerBase
    {
        ...
        [HttpGet("GetUserByOwnerShipId/{ownershipId}")]
        public async Task<IActionResult> GetUserByOwnerShipId(Guid ownershipId)
        {
            var response = await _ownerShipService.GetUserByOwnerShipId(ownershipId);

...
namespace TFU_Building_API.Service.impl
{
    public class InvoiceService : BaseHandler, IInvoiceService
    {
        ...
        //        {
        //            decimal unitPriceWithDiscount;
        //            decimal baseUnitPrice = serviceContract.Service.UnitPrice;

        //            // Kiểm tra chiết khấu từ PackageService
        //            decimal discount = serviceContract.PackageService?.Discount ?? 0;

        //            // Tính giá của mỗi đơn vị sau khi áp dụng chiết khấu
        //            unitPriceWithDiscount = baseUnitPrice * (1 - discount / 100);

        //            // Kiểm tra Apartment và ApartmentType tồn tại trước khi truy cập
        //            decimal totalAmount;
        //            if (serviceContract.Service.Unit == "m2" && serviceContract.Apartment != null && serviceContract.Apartment.ApartmentType != null)
        //            {
        //                // Nếu đơn vị là "m2", lấy diện tích từ LandArea của ApartmentType
        //                totalAmount = unitPriceWithDiscount * serviceContract.Apartment.ApartmentType.LandArea;
        //            }
        //            else
        //            {
        //                // Nếu không, tính tổng cho tất cả số lượng đã chiết khấu
        //                totalAmount = (serviceContract.Quantity ?? 0) * unitPriceWithDiscount;
        //            }

...
namespace TFU_Resident_API.Migrations
{
    ...
    [Migration("20241128134522_Dbv9_updateUser")]
    partial class Dbv9_updateUser
    {
            ...
            modelBuilder.Entity("Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            InsertedAt = new DateTime(2024, 11, 28, 20, 45, 21, 928, DateTimeKind.Local).AddTicks(9918),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "User",
                            UpdatedAt = new DateTime(2024, 11, 28, 20, 45, 21, 928, DateTimeKind.Local).AddTicks(9934)
                        },
                        new
                        {
                            Id = new Guid("7fe6bd0c-afe5-489d-982d-6f107f1d06fd"),
                            InsertedAt = new DateTime(2024, 11, 28, 20, 45, 21, 928, DateTimeKind.Local).AddTicks(9937),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Admin",
                            UpdatedAt = new DateTime(2024, 11, 28, 20, 45, 21, 928, DateTimeKind.Local).AddTicks(9938)
                        });
                });
